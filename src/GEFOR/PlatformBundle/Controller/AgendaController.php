...
use GEFOR\PlatformBundle\Entity\Agenda;
...
class AgendaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $agendas = $em->getRepository('GEFORPlatformBundle:Agenda')->findAll();
    ...
    {
        $agenda = new Agenda();
        $form = $this->createForm('GEFOR\PlatformBundle\Form\AgendaType', $agenda);
    ...
    {
        $deleteForm = $this->createDeleteForm($agenda);
        $editForm = $this->createForm('GEFOR\PlatformBundle\Form\AgendaType', $agenda);
